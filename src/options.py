...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--resize_size', type=int, default=148, help='resized image size for training')#256
    self.parser.add_argument('--crop_size', type=int, default=128, help='cropped image size for training')#216
